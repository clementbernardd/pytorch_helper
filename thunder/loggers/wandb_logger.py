...
class WandbLogger(LoggerAbstract):
    ...
    def __init__(self, name: str = "rna-bert-angles", is_local: bool = False, *args, **kwargs):
        """
    ...
    def init_logger(self, config: Optional[Dict] = {},*args, **kwargs):
        ...
        wandb.init(project="pfam_classification", name=self.name, config=config, mode=mode, dir="logs")
